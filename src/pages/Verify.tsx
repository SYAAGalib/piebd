...
const certificates: Record<string, {
  ...
  "CERT-2025-007": {
    ...
    issuedDate: "06 October, 2025",
    photo: defaultAvatar,
    certificateId: "CERT-2025-007",
    certificateImage: certificate7,
  },
  "CERT-2025-008": {
    valid: true,
    name: "Pashla Warisha Prova",
    role: "Intern Software Engineer",
    duration: "6 months",
    from: "01 October, 2024",
    to: "31 March, 2025",
  ...
  "CERT-2025-011": {
    ...
    issuedDate: "06 October, 2025",
    photo: defaultAvatar,
    certificateId: "CERT-2025-011",
    certificateImage: certificate11,
  },
  "CERT-2025-012": {
    valid: true,
    name: "Islami Sohela Tabassum",
    role: "Software Engineer",
    duration: "6 months",
    from: "01 October, 2024",
    to: "31 March, 2025",
    issuedDate: "06 October, 2025",
    photo: defaultAvatar,
    certificateId: "CERT-2025-012",
    certificateImage: certificate12,
  },
  "CERT-2025-013": {
    valid: true,
    name: "Kazi Nahin Mahmud",
    role: "Software Engineer",
    duration: "6 months",
    from: "01 October, 2024",
    to: "31 March, 2025",
